...
const IntercomNotifications = ({ navigation }) => {
  ...
  const handleSaveNotificationStatus = () => {
    SendSMSMessageWithUpdate(
      ...
      `${UserStore.sites[UserStore.activeSiteID].passcode}#80${notificationStatus}#`,
  ...
  const handleSaveMessage = () => {
    const content = `${UserStore.sites[UserStore.activeSiteID].passcode}#79${notificationMessage}#`;
    SendSMSMessageWithUpdate(
  ...
  const handleSaveNotificationNumbers = () => {
    let output = notificationNumbers.map(number => {
      return number.length === 0 ? '' : `78${number}#`;
    }).join('');
  ...
  return (
    <>
          ...
          <View style={styles.optionContainer}>
            ...
            <View style={styles.section}>
              ...
              <AESText
                ...
                size={16}
                content={t('notifications_message')}
      ...
      <ConfirmationModal
        ...
        onPress={() => {
          SendSMSMessageWithUpdate(
            ...
            `${UserStore.sites[UserStore.activeSiteID].passcode}#78*#`,
            UserStore.sites[UserStore.activeSiteID].telephoneNumber,
            'notificationNumbers',
      ...
      <ConfirmationModal
        ...
        header={title}
        body={'You can only be notified on devices if Relay 1 or Relay 2 is activated'}
...
export default IntercomNotifications;
