...
@observer
class LoopProgramMode extends Component {
                        ...
                        <View style={styles.optionContainer}>
                            ...
                            <View style={{marginBottom:30,marginTop:10}}>
                                <AESText
                                    ...
                                    size={16}
                                    content={t('program_mode_message')}
                                />
                            </View>
                                    ...
                                    onPress={()=>{
                                        if(this.openModeDisabled) {
                                            SendSMSMessageWithUpdate(
                                                `Program mode has been disabled`,
...
export default withTranslation()(LoopProgramMode);
